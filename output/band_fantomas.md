...
Andrey 15.12.2003 11:00:
2IP:<BR> Fantomas, насколько я знаю, сделали саунд трек не к фильму, а к одноименному комиксу.<BR>Даже композиции(если можно так назвать конечно :))) именуются "Frame (номер станицы)...(номер картинки)" 
